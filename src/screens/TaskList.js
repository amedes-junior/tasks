...
export default class TaskList extends Component {
  ...
  loadTasks = async () => {
    try {
      const maxDate = moment().add({days: this.props.daysAhead}).format('YYYY-MM-DD 23:59:29')
    ...
    return (
      <View style={styles.container}>
          ...
          style={styles.background}>
            ...
            <View style={styles.iconBar}>
             ...
             <TouchableOpacity onPress={() => this.props.navigation.openDrawer()}>
                <Icon name='bars'
                  size={20} color={commonStyles.colors.colorSecundary}
                />
              </TouchableOpacity>
        ...
        <TouchableOpacity style={[styles.addButton,{backgroundColor: this.getColor()}]}
          ...
          activeOpacity={0.7}>
          <Icon name='plus' size={20} color={commonStyles.colors.colorSecundary}/>
        </TouchableOpacity>
